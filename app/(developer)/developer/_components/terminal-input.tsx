  ...
  return (
    <div className={cn('pt-4', type == 'current' && 'px-4')}>
      <div className="flex  items-center">
        <div className="bg-[#ff0000] py-1 px-4 rounded-full z-20 flex gap-2">
          <FaCanadianMapleLeaf className="size-5" />
          <p>yuvraj</p>
        </div>
        <div className="bg-amber-600 py-1 px-4 pl-6 rounded-full -ml-5 z-10 flex gap-2">
          <Folder className="size-5" />
          <p>portfolio</p>
        </div>
        {value && (
          <div className="bg-[#fdcf58] py-1 px-4 pl-6 rounded-full -ml-5 flex gap-2">
